...
show_pars(res_activity_corr)
```
```{r grid_corr_function, include = TRUE, fig.width = 6.5, fig.height = 6.5}
...
show_pars(res_activity_diff)
```
```{r grid_diff_function, include = TRUE, fig.width = 10.5, fig.height = 10.5}
